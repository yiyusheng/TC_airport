...
test_arima <- function(df,use10min = T,avgMove = F){
  cat(sprintf('test_AFR::test_arima\tWIFIAPTag:%s\n',df$WIFIAPTag[1]))
  train.start <- as.POSIXct('2016-09-10 19:00:00',tz = 'UTC')
  train.end <- as.POSIXct('2016-09-25 12:00:00',tz = 'UTC')
  
  test.start <- as.POSIXct('2016-09-25 12:00:00',tz = 'UTC')
  test.end <- as.POSIXct('2016-09-25 15:00:00',tz = 'UTC')
  ...
  fit <- auto.arima(tsdata,D = 1,trace = F,
